...
setwd("C:/Users/Andrew Pomykalski/Desktop/STAT 6021 - Linear Models")
library(readr)
uno <- read.csv("Homework08data01.csv")
dos <- read.csv("Homework08data02.csv")
tres <- read.csv("Homework08data03.csv")
